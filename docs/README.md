...
- New example: [concept_curve.gif](docs/examples/concept_curve.gif) — the same
...
![Extract H3 RefMod in use](docs/examples/Extracting_example.png)
...
![Load H3 RefMods in use](docs/examples/loading_ref_example.png)
...
![Load H3 RefMod Folder in use](docs/examples/load_ref_folder_example.png)

### Concept vs identity (pool size in action)

The two training-mode pools compared — 8×8 concept vs 16×16 identity:

![Concept pool 8x8 — with and without the mod](docs/examples/concept_example_with_without_comparission.gif)

![Identity pool 16x16](docs/examples/id_example.gif)
...
![Identity success — ginger woman / JoJo style](docs/examples/id_sucess.gif)
...
![Curve controls — nothing vs concept at the end vs concept at the end + 3 copies](docs/examples/concept_curve.gif)
...
![Fast motion gets smeared](docs/examples/know_issues_1.gif)
